  ...
  const handleAuthPlayer = async () => {
    ...
    if (player) {
      ...
      if (targetPlayer) {
        ...
        await manageWallets(props.arkaneConnect);
        const wallets = await getWallets(props.arkaneConnect);
        await setPlayer({ ...targetPlayer, wallets: wallets });
      } else {
                          ...
                          values.animationUrls.map((animationUrls, index) => {
                            return (
                              <div class="row" key={index}>
                                <div class="col">
                                  <label
                                    htmlFor={`animationUrls.${index}.type`}
                                  >
                                    Type
                                  </label>
                                  <Field
                                ...
                                <div class="col">
                                  <label
                                    htmlFor={`animationUrls.${index}.value`}
                                  >
                                    Value
                                  </label>
                                  <Field
                  ...
                  player.wallets.map((wallet, index) => {
                    return (
                      <>
                        ...
                        <Tile>
                          <label htmlFor="walletId">WALLET #{index} ID:</label>
