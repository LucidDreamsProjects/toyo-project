      ...
      .request({
        ...
        params: {
          ...
          options: {
            ...
            decimals: 0,
            image:
              "https://ipfs.io/ipfs/QmbCZgCm5KkP7KSWLfR67nd4NR1Kt56j6f85ZcGZ4Ur7vS",
          },
        },
      })
      .then((success) => {
  ...
  (App = {
    ...
    initTokenType(typeId) {
      ...
      quantityInput.change(function () {
        ...
        priceMatic.html(
          web3.utils.fromWei(
            App.tokenRate[typeId].mul(App.tokenQuantity[typeId]),
            "ether"
          )
        );
    ...
    refreshMaticUsdPrice() {
      ...
      if (App.validNetwork.ChainId == Networks.Ganache.ChainId) {
        const infura = new Web3(
          "https://polygon-mainnet.infura.io/v3/39180531508b4b659780ef7a36426a86"
        );
    ...
    initContracts: function () {
      ...
      $.getJSON(
        "contracts/NftTokenCrowdsale.json",
        function (nftTokenCrowdsale) {
          ...
          if (App.validNetwork.ChainId == Networks.Ganache.ChainId) {
            Contracts.nftTokenCrowdsalePromise =
              App.contracts.NftTokenCrowdsale.deployed();
          } else {
            Contracts.nftTokenCrowdsalePromise =
              App.contracts.NftTokenCrowdsale.at(
                Contracts.nftTokenCrowdsaleAddress
              );
          }

          Contracts.nftTokenCrowdsalePromise.then(function (instance) {
            Contracts.nftTokenCrowdsaleInstance = instance;
            Contracts.nftTokenCrowdsaleAddress = instance.address;
          });

          $(".nft-factory .wallet-address").html(
            Contracts.nftTokenCrowdsaleAddress
          );
          $(".nft-factory a").attr(
            "href",
        ...
        $.getJSON("contracts/NftToken.json", function (nftToken) {
          ...
          if (App.validNetwork.ChainId == Networks.Ganache.ChainId) {
            ...
            Contracts.nftTokenPromise = App.contracts.NftToken.at(
              Contracts.nftTokenAddress
            );
          }

          Contracts.nftTokenPromise.then(function (instance) {
          ...
          $(".nft-token a").attr(
            "href",
            "https://mumbai.polygonscan.com/token/" + Contracts.nftTokenAddress
          );
    ...
    refreshTokenRate: function (typeId) {
      Contracts.nftTokenCrowdsalePromise.then(function (instance) {
        instance.getRate(typeId).then(function (rate) {
    ...
    getTotalMinted: function () {
      Contracts.nftTokenCrowdsalePromise.then(function (instance) {
        instance.getTotalMinted().then(function (totalMinted) {
    ...
    getTotalSupply: function (typeId) {
      Contracts.nftTokenCrowdsalePromise.then(function (instance) {
        instance.getTotalSupply(typeId).then(function (totalSupply) {
    ...
    getMaxSupply: function (typeId) {
      Contracts.nftTokenCrowdsalePromise.then(function (instance) {
        instance.getMaxSupply(typeId).then(function (maxSupply) {
          var _tokenType = $('[data-token-type="' + typeId + '"]');
    ...
    getPurchaseCap: function (typeId) {
      Contracts.nftTokenCrowdsalePromise.then(function (instance) {
        instance.getPurchaseCap(typeId).then(function (purchaseCap) {
          var _tokenType = $('[data-token-type="' + typeId + '"]');
    ...
    getPurchaseTimeLock: function () {
      Contracts.nftTokenCrowdsalePromise.then(function (instance) {
        instance.purchaseTimeLock.call().then(function (purchaseTimeLock) {
    ...
    getLastPurchaseTime: function (address) {
      Contracts.nftTokenCrowdsalePromise.then(function (instance) {
        instance.getLastPurchaseTime(address).then(function (lastPurchaseTime) {
    ...
    enableCountdown: function () {
      ...
      App.timerId = setInterval(App.doCountdown, 1000);
    },
