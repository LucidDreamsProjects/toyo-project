        ...
        <div class="row">
          ...
          <p id="MetaMaskButtons">
            ...
            <button
              ...
              style="display:none;width:345px;margin-right:10px;"
            >
              <img src="images/metamask.png" height="30px" />
              Connected wallet
            </button>
            ...
            <button
              id="connectButton"
              onClick="MetaMask.switchNetwork()"
            ...
            <button
              id="addToWalletButton"
              onClick="MetaMask.addToWallet()"
              class="btn btn-outline-secondary btn-lg"
            >
              <img
                src="https://ipfs.io/ipfs/QmbCZgCm5KkP7KSWLfR67nd4NR1Kt56j6f85ZcGZ4Ur7vS"
                height="30px"
              />
              Add TOYF9
            </button>
          ...
          <div id="content" class="text-center" style="display: none;">
            <p class="account">
              <span class="box">
                Your wallet <span class="wallet-address"></span>
              </span>
            </p>
          ...
          <span class="wallet-address"></span></a>
            ...
            <p>
              You currently have <span class="dapp-balance"></span>&nbsp;Toyos
            </p>
                ...
                <div class="card mb-4 rounded-3 shadow-sm border-primary">
                  ...
                  <div class="card-body" data-token-type="1">
                    ...
                    <ul class="list-unstyled mt-3 mb-4">
                      ...
                      <li>
                        <span class="purchase-cap">-</span> limit per
                        transaction
                      </li>
                      <li>
                        <span class="total-supply">-</span> minted /{" "}
                        <span class="max-supply">-</span> max supply
                      </li>
                    </ul>
                    <button
                      type="submit"
                      id="token1-buy"
                      disabled
                      onclick="App.buyTokens(App.tokenTypesForSale[0])"
                      class="w-100 btn btn-lg btn-primary buy"
                    >
                      Buy
                    </button>
                  </div>
                ...
                <div class="card mb-4 rounded-3 shadow-sm border-primary">
                  ...
                  <div class="card-body" data-token-type="2">
                    ...
                    <button
                      type="submit"
                      disabled
                      onclick="App.buyTokens(App.tokenTypesForSale[1])"
                      class="w-100 btn btn-lg btn-primary buy"
                    >
                      Buy
                    </button>
